...
/////////////////////////////////////////////////////////////////////////
// Acknowledgements:
//	o	Thanks to Cristi Posea for CSizingControlBar.
//	o	Thanks to WangJun for his article.
//  o   Thanks to hengai for helping me fix memory leak.
//	o	Thanks to all for helping me in developing.
//
//////////////////////////////////////////////////////////////////////////
//Updates
//////////////////////////////////////////////////////////////////////////
...
IMPLEMENT_DYNAMIC( CDockPageBar, CSizingControlBar );
...
{
	POSITION pos;
	for( pos = m_PageList.GetHeadPosition(); pos; )
	{
...
BEGIN_MESSAGE_MAP( CDockPageBar, CSizingControlBar )
...
afx_msg UINT CDockPageBar::OnNcHitTest(CPoint point)
#else
afx_msg LRESULT CDockPageBar::OnNcHitTest(CPoint point)
#endif
...
void CDockPageBar::OnNcPaint()
{
	...
	mdc.FillRect( rcDraw, CBrush::FromHandle( reinterpret_cast<HBRUSH>( GetClassLong( m_hWnd, GCL_HBRBACKGROUND ) ) ) );	
...
void CDockPageBar::OnNcLButtonDown(UINT nFlags, CPoint point) 
{
	...
	{
		CSizingControlBar::OnNcLButtonDown(nFlags, point);	
		return;
	}
