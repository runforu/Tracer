...
//Methods
    ...
    {
        return m_bRegularExpression;
    };
    void SetRegularExpression(BOOL bRegularExpression)
    {
...
//Methods
    ...
    void            SetMargins(const CRect& rMargin)
    {
        m_rMargin = rMargin;
    };
    ...
    BOOL            GetUseROFileAttributeDuringLoading() const
    {
        return m_bUseROFileAttributeDuringLoading;
    };
    void            SetUseROFileAttributeDuringLoading(BOOL bUseROFileAttributeDuringLoading)
    {
        m_bUseROFileAttributeDuringLoading = bUseROFileAttributeDuringLoading;
    };
