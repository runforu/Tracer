...
IMPLEMENT_DYNAMIC(CSizingControlBarCF, CSizingControlBarG);
...
BEGIN_MESSAGE_MAP(CSizingControlBarCF, CSizingControlBarG)
...
{
    CSizingControlBarG::OnUpdateCmdUI(pTarget, bDisableIfNoHndler);
...
{
    LRESULT lResult = CSizingControlBarG::OnSetText(wParam, lParam);
